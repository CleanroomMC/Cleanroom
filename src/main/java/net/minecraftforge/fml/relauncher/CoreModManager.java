...
public class CoreModManager {
    ...
    private static String[] rootPlugins = { "net.minecraftforge.fml.relauncher.FMLCorePlugin", "net.minecraftforge.classloading.FMLForgePlugin", "net.minecraftforge.fml.relauncher.MixinBooterPlugin", "net.minecraftforge.fml.relauncher.ConfigAnytimePlugin" };
