                ...
                try {
                    ...
                    for (ModContainer container : this.loader.getActiveModList()) {
                        try (JarFile jarFile = new JarFile(container.getSource())) {
                            ...
                            FMLLog.log.error("Failed to handle manifest of {}", container.getModId());
                        }
                    }
                    ...
                    for (Config config : ImmutableSet.<Config>builder()
                            .addAll(Mixins.getConfigs())
                            .addAll(Config.getAllConfigs().values())
                            .build()) {
