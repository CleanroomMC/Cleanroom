...
public class EXTSeparateShaderObjects {
    ...
    public static void glActiveProgramEXT(int program) {
        org.lwjgl3.opengl.EXTSeparateShaderObjects.glActiveProgramEXT(program);
    }

    public static int glCreateShaderProgramEXT(int type, java.lang.CharSequence string) {
        return org.lwjgl3.opengl.EXTSeparateShaderObjects.glCreateShaderProgramEXT(type, string);
    }
    ...
    public static void glUseShaderProgramEXT(int type, int program) {
        org.lwjgl3.opengl.EXTSeparateShaderObjects.glUseShaderProgramEXT(type, program);
    }
}
