...
public class ARBVertexShader {
    ...
    public static void glBindAttribLocationARB(int programObj, int index, java.lang.CharSequence name) {
        org.lwjgl3.opengl.ARBVertexShader.glBindAttribLocationARB(programObj, index, name);
    }
    ...
    public static void glDisableVertexAttribArrayARB(int index) {
        org.lwjgl3.opengl.ARBVertexShader.glDisableVertexAttribArrayARB(index);
    }

    public static void glEnableVertexAttribArrayARB(int index) {
        org.lwjgl3.opengl.ARBVertexShader.glEnableVertexAttribArrayARB(index);
    }
    ...
    public static void glGetActiveAttribARB(int programObj, int index, java.nio.IntBuffer length,
        ...
        org.lwjgl3.opengl.ARBVertexShader.glGetActiveAttribARB(programObj, index, length, size, type, name);
    }

    public static int glGetAttribLocationARB(int programObj, java.lang.CharSequence name) {
        return org.lwjgl3.opengl.ARBVertexShader.glGetAttribLocationARB(programObj, name);
    }
    ...
    public static void glVertexAttribPointerARB(int index, int size, boolean normalized, int stride,
        ...
        org.lwjgl3.opengl.ARBVertexShader
                .glVertexAttribPointerARB(index, size, org.lwjgl3.opengl.GL11.GL_FLOAT, normalized, stride, buffer);
    }
