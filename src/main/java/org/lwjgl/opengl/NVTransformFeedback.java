...
public class NVTransformFeedback {
    ...
    public static void glActiveVaryingNV(int program, java.lang.CharSequence name) {
        org.lwjgl3.opengl.NVTransformFeedback.glActiveVaryingNV(program, name);
    }
    ...
    public static void glBeginTransformFeedbackNV(int primitiveMode) {
        org.lwjgl3.opengl.NVTransformFeedback.glBeginTransformFeedbackNV(primitiveMode);
    }

    public static void glBindBufferBaseNV(int target, int index, int buffer) {
        org.lwjgl3.opengl.NVTransformFeedback.glBindBufferBaseNV(target, index, buffer);
    }

    public static void glBindBufferOffsetNV(int target, int index, int buffer, long offset) {
        org.lwjgl3.opengl.NVTransformFeedback.glBindBufferOffsetNV(target, index, buffer, offset);
    }

    public static void glBindBufferRangeNV(int target, int index, int buffer, long offset, long size) {
        org.lwjgl3.opengl.NVTransformFeedback.glBindBufferRangeNV(target, index, buffer, offset, size);
    }

    public static void glEndTransformFeedbackNV() {
        org.lwjgl3.opengl.NVTransformFeedback.glEndTransformFeedbackNV();
    }
    ...
    public static void glGetActiveVaryingNV(int program, int index, java.nio.IntBuffer length, java.nio.IntBuffer size,
        ...
        org.lwjgl3.opengl.NVTransformFeedback.glGetActiveVaryingNV(program, index, length, size, type, name);
    }

    public static int glGetTransformFeedbackVaryingNV(int program, int index) {
        return org.lwjgl3.opengl.NVTransformFeedback.glGetTransformFeedbackVaryingNV(program, index);
    }

    public static void glGetTransformFeedbackVaryingNV(int program, int index, java.nio.IntBuffer location) {
        org.lwjgl3.opengl.NVTransformFeedback.glGetTransformFeedbackVaryingNV(program, index, location);
    }

    public static int glGetVaryingLocationNV(int program, java.lang.CharSequence name) {
        return org.lwjgl3.opengl.NVTransformFeedback.glGetVaryingLocationNV(program, name);
    }
    ...
    public static void glTransformFeedbackAttribsNV(java.nio.IntBuffer attribs, int bufferMode) {
        org.lwjgl3.opengl.NVTransformFeedback.glTransformFeedbackAttribsNV(attribs, bufferMode);
    }

    public static void glTransformFeedbackVaryingsNV(int program, java.nio.IntBuffer locations, int bufferMode) {
        org.lwjgl3.opengl.NVTransformFeedback.glTransformFeedbackVaryingsNV(program, locations, bufferMode);
    }
}
