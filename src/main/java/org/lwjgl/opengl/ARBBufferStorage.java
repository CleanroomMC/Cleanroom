...
public class ARBBufferStorage {
    ...
    public static void glBufferStorage(int target, long size, int flags) {
        org.lwjgl3.opengl.ARBBufferStorage.glBufferStorage(target, size, flags);
    }

    public static void glBufferStorage(int target, java.nio.ByteBuffer data, int flags) {
        org.lwjgl3.opengl.ARBBufferStorage.glBufferStorage(target, data, flags);
    }
    ...
    public static void glNamedBufferStorageEXT(int buffer, long size, int flags) {
        org.lwjgl3.opengl.ARBBufferStorage.glNamedBufferStorageEXT(buffer, size, flags);
    }

    public static void glNamedBufferStorageEXT(int buffer, java.nio.ByteBuffer data, int flags) {
        org.lwjgl3.opengl.ARBBufferStorage.glNamedBufferStorageEXT(buffer, data, flags);
    }
