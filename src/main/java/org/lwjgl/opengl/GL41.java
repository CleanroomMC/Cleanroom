...
public class GL41 {
    ...
    public static void glActiveShaderProgram(int pipeline, int program) {
        org.lwjgl3.opengl.GL41.glActiveShaderProgram(pipeline, program);
    }

    public static void glBindProgramPipeline(int pipeline) {
        org.lwjgl3.opengl.GL41.glBindProgramPipeline(pipeline);
    }

    public static void glClearDepthf(float d) {
        org.lwjgl3.opengl.GL41.glClearDepthf(d);
    }

    public static int glCreateShaderProgram(int type, java.lang.CharSequence string) {
        return org.lwjgl3.opengl.GL41.glCreateShaderProgramv(type, string);
    }

    public static int glCreateShaderProgram(int type, java.nio.ByteBuffer string) {

        int returnValue = org.lwjgl3.opengl.GL41
    ...
    public static void glDeleteProgramPipelines(int pipeline) {
        org.lwjgl3.opengl.GL41.glDeleteProgramPipelines(pipeline);
    }

    public static void glDeleteProgramPipelines(java.nio.IntBuffer pipelines) {
        org.lwjgl3.opengl.GL41.glDeleteProgramPipelines(pipelines);
    }

    public static void glDepthRangeArray(int first, java.nio.DoubleBuffer v) {
        org.lwjgl3.opengl.GL41.glDepthRangeArrayv(first, v);
    }

    public static void glDepthRangeIndexed(int index, double n, double f) {
        org.lwjgl3.opengl.GL41.glDepthRangeIndexed(index, n, f);
    }

    public static void glDepthRangef(float n, float f) {
        org.lwjgl3.opengl.GL41.glDepthRangef(n, f);
    }

    public static int glGenProgramPipelines() {
        return org.lwjgl3.opengl.GL41.glGenProgramPipelines();
    }

    public static void glGenProgramPipelines(java.nio.IntBuffer pipelines) {
        org.lwjgl3.opengl.GL41.glGenProgramPipelines(pipelines);
    }

    public static void glGetDouble(int target, int index, java.nio.DoubleBuffer data) {
        org.lwjgl3.opengl.GL41.glGetDoublei_v(target, index, data);
    }

    public static void glGetFloat(int target, int index, java.nio.FloatBuffer data) {
        org.lwjgl3.opengl.GL41.glGetFloati_v(target, index, data);
    }
    ...
    public static void glGetProgramBinary(int program, java.nio.IntBuffer length, java.nio.IntBuffer binaryFormat,
        ...
        org.lwjgl3.opengl.GL41.glGetProgramBinary(program, length, binaryFormat, binary);
    }

    public static void glGetProgramPipeline(int pipeline, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.GL41.glGetProgramPipelineiv(pipeline, pname, params);
    }

    public static java.lang.String glGetProgramPipelineInfoLog(int pipeline, int bufSize) {
        return org.lwjgl3.opengl.GL41.glGetProgramPipelineInfoLog(pipeline, bufSize);
    }

    public static void glGetProgramPipelineInfoLog(int pipeline, java.nio.IntBuffer length,
            java.nio.ByteBuffer infoLog) {
        org.lwjgl3.opengl.GL41.glGetProgramPipelineInfoLog(pipeline, length, infoLog);
    }

    public static int glGetProgramPipelinei(int pipeline, int pname) {
        return org.lwjgl3.opengl.GL41.glGetProgramPipelinei(pipeline, pname);
    }
