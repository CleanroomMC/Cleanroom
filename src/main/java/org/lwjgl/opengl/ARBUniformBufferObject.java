...
public class ARBUniformBufferObject {
    ...
    public static void glBindBufferBase(int target, int index, int buffer) {
        org.lwjgl3.opengl.ARBUniformBufferObject.glBindBufferBase(target, index, buffer);
    }

    public static void glBindBufferRange(int target, int index, int buffer, long offset, long size) {
        org.lwjgl3.opengl.ARBUniformBufferObject.glBindBufferRange(target, index, buffer, offset, size);
    }
    ...
    public static void glGetActiveUniformBlockName(int program, int uniformBlockIndex, java.nio.IntBuffer length,
        ...
        org.lwjgl3.opengl.ARBUniformBufferObject
                .glGetActiveUniformBlockName(program, uniformBlockIndex, length, uniformBlockName);
    }

    public static int glGetActiveUniformBlocki(int program, int uniformBlockIndex, int pname) {
        return org.lwjgl3.opengl.ARBUniformBufferObject.glGetActiveUniformBlocki(program, uniformBlockIndex, pname);
    }

    public static java.lang.String glGetActiveUniformName(int program, int uniformIndex, int bufSize) {
        return org.lwjgl3.opengl.ARBUniformBufferObject.glGetActiveUniformName(program, uniformIndex, bufSize);
    }
    ...
    public static void glGetActiveUniformName(int program, int uniformIndex, java.nio.IntBuffer length,
        ...
        org.lwjgl3.opengl.ARBUniformBufferObject.glGetActiveUniformName(program, uniformIndex, length, uniformName);
    }

    public static int glGetActiveUniformsi(int program, int uniformIndex, int pname) {
        return org.lwjgl3.opengl.ARBUniformBufferObject.glGetActiveUniformsi(program, uniformIndex, pname);
    }

    public static int glGetUniformBlockIndex(int program, java.lang.CharSequence uniformBlockName) {
        return org.lwjgl3.opengl.ARBUniformBufferObject.glGetUniformBlockIndex(program, uniformBlockName);
    }
    ...
    public static void glGetUniformIndices(int program, java.lang.CharSequence[] uniformNames,
        ...
        org.lwjgl3.opengl.ARBUniformBufferObject.glGetUniformIndices(program, uniformNames, uniformIndices);
    }

    public static void glUniformBlockBinding(int program, int uniformBlockIndex, int uniformBlockBinding) {
        org.lwjgl3.opengl.ARBUniformBufferObject.glUniformBlockBinding(program, uniformBlockIndex, uniformBlockBinding);
    }
}
