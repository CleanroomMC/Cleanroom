...
public class ARBImaging {
    ...
    public static void glBlendColor(float red, float green, float blue, float alpha) {
        org.lwjgl3.opengl.ARBImaging.glBlendColor(red, green, blue, alpha);
    }

    public static void glBlendEquation(int mode) {
        org.lwjgl3.opengl.ARBImaging.glBlendEquation(mode);
    }

    public static void glColorSubTable(int target, int start, int count, int format, int type,
            long data_buffer_offset) {
        org.lwjgl3.opengl.ARBImaging.glColorSubTable(target, start, count, format, type, data_buffer_offset);
    }

    public static void glColorSubTable(int target, int start, int count, int format, int type,
            java.nio.ByteBuffer data) {
        org.lwjgl3.opengl.ARBImaging.glColorSubTable(target, start, count, format, type, data);
    }

    public static void glColorSubTable(int target, int start, int count, int format, int type,
            java.nio.DoubleBuffer data) {

        org.lwjgl3.opengl.ARBImaging
                .glColorSubTable(target, start, count, format, type, org.lwjgl.MemoryUtil.getAddress(data));
    }
    ...
    public static void glColorTable(int target, int internalFormat, int width, int format, int type,
            long data_buffer_offset) {
        org.lwjgl3.opengl.ARBImaging.glColorTable(target, internalFormat, width, format, type, data_buffer_offset);
    }

    public static void glColorTable(int target, int internalFormat, int width, int format, int type,
            java.nio.ByteBuffer data) {
        org.lwjgl3.opengl.ARBImaging.glColorTable(target, internalFormat, width, format, type, data);
    }
    ...
    public static void glColorTable(int target, int internalFormat, int width, int format, int type,
        ...
        org.lwjgl3.opengl.ARBImaging
                .glColorTable(target, internalFormat, width, format, type, org.lwjgl.MemoryUtil.getAddress(data));
    }
    ...
    public static void glColorTableParameter(int target, int pname, java.nio.FloatBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glColorTableParameterfv(target, pname, params);
    }

    public static void glColorTableParameter(int target, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glColorTableParameteriv(target, pname, params);
    }
    ...
    public static void glConvolutionFilter1D(int target, int internalformat, int width, int format, int type,
        ...
        org.lwjgl3.opengl.ARBImaging.glConvolutionFilter1D(target, internalformat, width, format, type, image);
    }

    public static void glConvolutionFilter1D(int target, int internalformat, int width, int format, int type,
            java.nio.DoubleBuffer image) {

        org.lwjgl3.opengl.ARBImaging.glConvolutionFilter1D(
                target,
                internalformat,
                width,
                format,
                type,
                org.lwjgl.MemoryUtil.getAddress(image));
    }
    ...
    public static void glConvolutionFilter2D(int target, int internalformat, int width, int height, int format,
        ...
        org.lwjgl3.opengl.ARBImaging.glConvolutionFilter2D(target, internalformat, width, height, format, type, image);
    }

    public static void glConvolutionFilter2D(int target, int internalformat, int width, int height, int format,
            int type, java.nio.IntBuffer image) {

        org.lwjgl3.opengl.ARBImaging.glConvolutionFilter2D(
                target,
                internalformat,
                width,
                height,
    ...
    public static void glGetColorTableParameter(int target, int pname, java.nio.FloatBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glGetColorTableParameterfv(target, pname, params);
    }

    public static void glGetColorTableParameter(int target, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glGetColorTableParameteriv(target, pname, params);
    }

    public static void glGetConvolutionFilter(int target, int format, int type, long image_buffer_offset) {
        org.lwjgl3.opengl.ARBImaging.glGetConvolutionFilter(target, format, type, image_buffer_offset);
    }

    public static void glGetConvolutionFilter(int target, int format, int type, java.nio.ByteBuffer image) {
        org.lwjgl3.opengl.ARBImaging.glGetConvolutionFilter(target, format, type, image);
    }

    public static void glGetConvolutionFilter(int target, int format, int type, java.nio.DoubleBuffer image) {

        org.lwjgl3.opengl.ARBImaging
                .glGetConvolutionFilter(target, format, type, org.lwjgl.MemoryUtil.getAddress(image));
    }
    ...
    public static void glGetConvolutionParameter(int target, int pname, java.nio.FloatBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glGetConvolutionParameterfv(target, pname, params);
    }

    public static void glGetConvolutionParameter(int target, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glGetConvolutionParameteriv(target, pname, params);
    }
    ...
    public static void glGetHistogram(int target, boolean reset, int format, int type, java.nio.ByteBuffer values) {
        org.lwjgl3.opengl.ARBImaging.glGetHistogram(target, reset, format, type, values);
    }

    public static void glGetHistogram(int target, boolean reset, int format, int type, java.nio.DoubleBuffer values) {

        org.lwjgl3.opengl.ARBImaging
                .glGetHistogram(target, reset, format, type, org.lwjgl.MemoryUtil.getAddress(values));
    }
    ...
    public static void glGetHistogramParameter(int target, int pname, java.nio.FloatBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glGetHistogramParameterfv(target, pname, params);
    }

    public static void glGetHistogramParameter(int target, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glGetHistogramParameteriv(target, pname, params);
    }

    public static void glGetMinmax(int target, boolean reset, int format, int types, long values_buffer_offset) {
        org.lwjgl3.opengl.ARBImaging.glGetMinmax(target, reset, format, types, values_buffer_offset);
    }

    public static void glGetMinmax(int target, boolean reset, int format, int types, java.nio.ByteBuffer values) {
        org.lwjgl3.opengl.ARBImaging.glGetMinmax(target, reset, format, types, values);
    }

    public static void glGetMinmax(int target, boolean reset, int format, int types, java.nio.DoubleBuffer values) {

        org.lwjgl3.opengl.ARBImaging.glGetMinmax(target, reset, format, types, org.lwjgl.MemoryUtil.getAddress(values));
    }
    ...
    public static void glGetMinmaxParameter(int target, int pname, java.nio.FloatBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glGetMinmaxParameterfv(target, pname, params);
    }

    public static void glGetMinmaxParameter(int target, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.ARBImaging.glGetMinmaxParameteriv(target, pname, params);
    }
    ...
    public static void glGetSeparableFilter(int target, int format, int type, java.nio.ByteBuffer row,
        ...
        org.lwjgl3.opengl.ARBImaging.glGetSeparableFilter(target, format, type, row, column, span);
    }
    ...
    public static void glGetSeparableFilter(int target, int format, int type, java.nio.ByteBuffer row,
        ...
        org.lwjgl3.opengl.ARBImaging.glGetSeparableFilter(
                target,
                format,
                type,
                org.lwjgl.MemoryUtil.getAddress(row),
                org.lwjgl.MemoryUtil.getAddress(column),
                wrappedArg5);
    ...
    public static void glHistogram(int target, int width, int internalformat, boolean sink) {
        org.lwjgl3.opengl.ARBImaging.glHistogram(target, width, internalformat, sink);
    }

    public static void glMinmax(int target, int internalformat, boolean sink) {
        org.lwjgl3.opengl.ARBImaging.glMinmax(target, internalformat, sink);
    }

    public static void glResetHistogram(int target) {
        org.lwjgl3.opengl.ARBImaging.glResetHistogram(target);
    }

    public static void glResetMinmax(int target) {
        org.lwjgl3.opengl.ARBImaging.glResetMinmax(target);
    }
    ...
    public static void glSeparableFilter2D(int target, int internalformat, int width, int height, int format, int type,
        ...
        org.lwjgl3.opengl.ARBImaging.glSeparableFilter2D(
                target,
                internalformat,
                width,
                height,
