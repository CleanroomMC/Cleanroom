...
public class NVVertexBufferUnifiedMemory {
    ...
    public static void glBufferAddressRangeNV(int pname, int index, long address, long length) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glBufferAddressRangeNV(pname, index, address, length);
    }

    public static void glColorFormatNV(int size, int type, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glColorFormatNV(size, type, stride);
    }

    public static void glEdgeFlagFormatNV(int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glEdgeFlagFormatNV(stride);
    }

    public static void glFogCoordFormatNV(int type, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glFogCoordFormatNV(type, stride);
    }

    public static void glGetIntegeruNV(int value, int index, java.nio.LongBuffer result) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glGetIntegerui64i_vNV(value, index, result);
    }

    public static void glIndexFormatNV(int type, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glIndexFormatNV(type, stride);
    }

    public static void glNormalFormatNV(int type, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glNormalFormatNV(type, stride);
    }

    public static void glSecondaryColorFormatNV(int size, int type, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glSecondaryColorFormatNV(size, type, stride);
    }

    public static void glTexCoordFormatNV(int size, int type, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glTexCoordFormatNV(size, type, stride);
    }

    public static void glVertexAttribFormatNV(int index, int size, int type, boolean normalized, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glVertexAttribFormatNV(index, size, type, normalized, stride);
    }

    public static void glVertexAttribIFormatNV(int index, int size, int type, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glVertexAttribIFormatNV(index, size, type, stride);
    }

    public static void glVertexFormatNV(int size, int type, int stride) {
        org.lwjgl3.opengl.NVVertexBufferUnifiedMemory.glVertexFormatNV(size, type, stride);
    }
}
