...
public class KDTreeTest {
    @Test
    public void testKNN() {
        Vector3b near = new Vector3b(0, 0, 0);
        Vector3b far = new Vector3b(15, 15, 15);
        KDTree kdTree = new KDTree(114514);
        kdTree.add(List.of(near, far));
        var neighbours = kdTree.knn(new Vector3b(14,14,14), 16, 1, false);
    ...
    public void testDeletion() {
        ...
        kdTree.add(List.of(near, far));
        kdTree.delete(far);
        var neighbours = kdTree.knn(new Vector3b(14,14,14), 32, 1, false);
    ...
    public void testConstruction() {
        ...
        List<Vector3b> list = new ArrayList<>();
        for (int x = 0; x < 16; x++) {
            for (int y = 0; y < 16; y++) {
                for (int z = 0; z < 16; z++) {
                    if (rng.nextBoolean()) {
                        list.add(new Vector3b(x, y, z));
                    }
                }
            }
        }
    ...
    public void testObjectRemoval() {
        ...
        try {
            ...
            var ns = kdTree.knn(new Vector3b(14,14,14), 10.f, 1, false);
