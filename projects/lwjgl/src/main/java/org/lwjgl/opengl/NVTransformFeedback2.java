...
public class NVTransformFeedback2 {
    ...
    public static void glBindTransformFeedbackNV(int target, int id) {
        org.lwjgl3.opengl.NVTransformFeedback2.glBindTransformFeedbackNV(target, id);
    }

    public static void glDeleteTransformFeedbacksNV(int id) {
        org.lwjgl3.opengl.NVTransformFeedback2.glDeleteTransformFeedbacksNV(id);
    }

    public static void glDeleteTransformFeedbacksNV(java.nio.IntBuffer ids) {
        org.lwjgl3.opengl.NVTransformFeedback2.glDeleteTransformFeedbacksNV(ids);
    }

    public static void glDrawTransformFeedbackNV(int mode, int id) {
        org.lwjgl3.opengl.NVTransformFeedback2.glDrawTransformFeedbackNV(mode, id);
    }

    public static int glGenTransformFeedbacksNV() {
        return org.lwjgl3.opengl.NVTransformFeedback2.glGenTransformFeedbacksNV();
    }

    public static void glGenTransformFeedbacksNV(java.nio.IntBuffer ids) {
        org.lwjgl3.opengl.NVTransformFeedback2.glGenTransformFeedbacksNV(ids);
    }

    public static boolean glIsTransformFeedbackNV(int id) {
        return org.lwjgl3.opengl.NVTransformFeedback2.glIsTransformFeedbackNV(id);
    }

    public static void glPauseTransformFeedbackNV() {
        org.lwjgl3.opengl.NVTransformFeedback2.glPauseTransformFeedbackNV();
    }

    public static void glResumeTransformFeedbackNV() {
        org.lwjgl3.opengl.NVTransformFeedback2.glResumeTransformFeedbackNV();
    }
}
