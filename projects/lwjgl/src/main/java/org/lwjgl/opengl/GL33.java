...
public class GL33 {
    ...
    public static void glBindFragDataLocationIndexed(int program, int colorNumber, int index,
        ...
        org.lwjgl3.opengl.GL33.glBindFragDataLocationIndexed(program, colorNumber, index, name);
    }
    ...
    public static void glBindSampler(int unit, int sampler) {
        org.lwjgl3.opengl.GL33.glBindSampler(unit, sampler);
    }

    public static void glColorP3u(int type, java.nio.IntBuffer color) {
        org.lwjgl3.opengl.GL33.glColorP3uiv(type, color);
    }

    public static void glColorP3ui(int type, int color) {
        org.lwjgl3.opengl.GL33.glColorP3ui(type, color);
    }

    public static void glColorP4u(int type, java.nio.IntBuffer color) {
        org.lwjgl3.opengl.GL33.glColorP4uiv(type, color);
    }

    public static void glColorP4ui(int type, int color) {
        org.lwjgl3.opengl.GL33.glColorP4ui(type, color);
    }

    public static void glDeleteSamplers(int sampler) {
        org.lwjgl3.opengl.GL33.glDeleteSamplers(sampler);
    }

    public static void glDeleteSamplers(java.nio.IntBuffer samplers) {
        org.lwjgl3.opengl.GL33.glDeleteSamplers(samplers);
    }

    public static int glGenSamplers() {
        return org.lwjgl3.opengl.GL33.glGenSamplers();
    }

    public static void glGenSamplers(java.nio.IntBuffer samplers) {
        org.lwjgl3.opengl.GL33.glGenSamplers(samplers);
    }

    public static int glGetFragDataIndex(int program, java.lang.CharSequence name) {
        return org.lwjgl3.opengl.GL33.glGetFragDataIndex(program, name);
    }
