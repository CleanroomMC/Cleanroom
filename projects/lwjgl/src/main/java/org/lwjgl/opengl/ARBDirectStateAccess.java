...
public class ARBDirectStateAccess {
    ...
    public static void glBindTextureUnit(int unit, int texture) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glBindTextureUnit(unit, texture);
    }
    ...
    public static void glBlitNamedFramebuffer(int readFramebuffer, int drawFramebuffer, int srcX0, int srcY0, int srcX1,
        ...
        org.lwjgl3.opengl.ARBDirectStateAccess.glBlitNamedFramebuffer(
                readFramebuffer,
                drawFramebuffer,
                srcX0,
                srcY0,
    ...
    public static int glCheckNamedFramebufferStatus(int framebuffer, int target) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCheckNamedFramebufferStatus(framebuffer, target);
    }

    public static void glClearNamedBufferData(int buffer, int internalformat, int format, int type,
            java.nio.ByteBuffer data) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glClearNamedBufferData(buffer, internalformat, format, type, data);
    }
    ...
    public static void glCompressedTextureSubImage1D(int texture, int level, int xoffset, int width, int format,
        ...
        org.lwjgl3.opengl.ARBDirectStateAccess.glCompressedTextureSubImage1D(
                texture,
                level,
                xoffset,
                width,
    ...
    public static void glCompressedTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width,
        ...
        org.lwjgl3.opengl.ARBDirectStateAccess.glCompressedTextureSubImage2D(
                texture,
                level,
                xoffset,
                yoffset,
    ...
    public static void glCompressedTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset,
        ...
        org.lwjgl3.opengl.ARBDirectStateAccess.glCompressedTextureSubImage3D(
                texture,
                level,
                xoffset,
                yoffset,
    ...
    public static void glCopyTextureSubImage1D(int texture, int level, int xoffset, int x, int y, int width) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCopyTextureSubImage1D(texture, level, xoffset, x, y, width);
    }
    ...
    public static int glCreateBuffers() {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateBuffers();
    }

    public static void glCreateBuffers(java.nio.IntBuffer buffers) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateBuffers(buffers);
    }

    public static int glCreateFramebuffers() {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateFramebuffers();
    }

    public static void glCreateFramebuffers(java.nio.IntBuffer framebuffers) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateFramebuffers(framebuffers);
    }

    public static int glCreateProgramPipelines() {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateProgramPipelines();
    }

    public static void glCreateProgramPipelines(java.nio.IntBuffer pipelines) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateProgramPipelines(pipelines);
    }

    public static int glCreateQueries(int target) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateQueries(target);
    }

    public static void glCreateQueries(int target, java.nio.IntBuffer ids) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateQueries(target, ids);
    }

    public static int glCreateRenderbuffers() {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateRenderbuffers();
    }

    public static void glCreateRenderbuffers(java.nio.IntBuffer renderbuffers) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateRenderbuffers(renderbuffers);
    }

    public static int glCreateSamplers() {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateSamplers();
    }

    public static void glCreateSamplers(java.nio.IntBuffer samplers) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateSamplers(samplers);
    }

    public static int glCreateTextures(int target) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateTextures(target);
    }

    public static void glCreateTextures(int target, java.nio.IntBuffer textures) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateTextures(target, textures);
    }

    public static int glCreateTransformFeedbacks() {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateTransformFeedbacks();
    }

    public static void glCreateTransformFeedbacks(java.nio.IntBuffer ids) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateTransformFeedbacks(ids);
    }

    public static int glCreateVertexArrays() {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glCreateVertexArrays();
    }

    public static void glCreateVertexArrays(java.nio.IntBuffer arrays) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glCreateVertexArrays(arrays);
    }

    public static void glDisableVertexArrayAttrib(int vaobj, int index) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glDisableVertexArrayAttrib(vaobj, index);
    }

    public static void glEnableVertexArrayAttrib(int vaobj, int index) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glEnableVertexArrayAttrib(vaobj, index);
    }

    public static void glFlushMappedNamedBufferRange(int buffer, long offset, long length) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glFlushMappedNamedBufferRange(buffer, offset, length);
    }

    public static void glGenerateTextureMipmap(int texture) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glGenerateTextureMipmap(texture);
    }
    ...
    public static void glGetCompressedTextureImage(int texture, int level, java.nio.ByteBuffer pixels) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glGetCompressedTextureImage(texture, level, pixels);
    }

    public static long glGetNamedBufferParameteri64(int buffer, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetNamedBufferParameteri64(buffer, pname);
    }

    public static int glGetNamedBufferParameteri(int buffer, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetNamedBufferParameteri(buffer, pname);
    }

    public static void glGetNamedBufferSubData(int buffer, long offset, java.nio.ByteBuffer data) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glGetNamedBufferSubData(buffer, offset, data);
    }
    ...
    public static void glGetTextureImage(int texture, int level, int format, int type, java.nio.ByteBuffer pixels) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glGetTextureImage(texture, level, format, type, pixels);
    }
    ...
    public static float glGetTextureLevelParameterf(int texture, int level, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTextureLevelParameterf(texture, level, pname);
    }

    public static int glGetTextureLevelParameteri(int texture, int level, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTextureLevelParameteri(texture, level, pname);
    }

    public static int glGetTextureParameterIi(int texture, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTextureParameterIi(texture, pname);
    }

    public static int glGetTextureParameterIui(int texture, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTextureParameterIui(texture, pname);
    }

    public static float glGetTextureParameterf(int texture, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTextureParameterf(texture, pname);
    }

    public static int glGetTextureParameteri(int texture, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTextureParameteri(texture, pname);
    }

    public static long glGetTransformFeedbacki64(int xfb, int pname, int index) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTransformFeedbacki64(xfb, pname, index);
    }

    public static int glGetTransformFeedbacki(int xfb, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTransformFeedbacki(xfb, pname);
    }

    public static int glGetTransformFeedbacki(int xfb, int pname, int index) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetTransformFeedbacki(xfb, pname, index);
    }

    public static long glGetVertexArrayIndexed64i(int vaobj, int index, int pname) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glGetVertexArrayIndexed64i(vaobj, index, pname);
    }

    public static void glInvalidateNamedFramebufferData(int framebuffer, java.nio.IntBuffer attachments) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glInvalidateNamedFramebufferData(framebuffer, attachments);
    }
    ...
    public static java.nio.ByteBuffer glMapNamedBuffer(int buffer, int access, long length,
        ...
        return org.lwjgl3.opengl.ARBDirectStateAccess.glMapNamedBuffer(buffer, access, length, old_buffer);
    }

    public static java.nio.ByteBuffer glMapNamedBuffer(int buffer, int access, java.nio.ByteBuffer old_buffer) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glMapNamedBuffer(buffer, access, old_buffer);
    }

    public static java.nio.ByteBuffer glMapNamedBufferRange(int buffer, long offset, long length, int access,
            java.nio.ByteBuffer old_buffer) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glMapNamedBufferRange(buffer, offset, length, access, old_buffer);
    }

    public static void glNamedBufferData(int buffer, long data_size, int usage) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedBufferData(buffer, data_size, usage);
    }

    public static void glNamedBufferData(int buffer, java.nio.ByteBuffer data, int usage) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedBufferData(buffer, data, usage);
    }
    ...
    public static void glNamedBufferStorage(int buffer, long size, int flags) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedBufferStorage(buffer, size, flags);
    }

    public static void glNamedBufferStorage(int buffer, java.nio.ByteBuffer data, int flags) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedBufferStorage(buffer, data, flags);
    }
    ...
    public static void glNamedBufferSubData(int buffer, long offset, java.nio.ByteBuffer data) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedBufferSubData(buffer, offset, data);
    }
    ...
    public static void glNamedFramebufferDrawBuffer(int framebuffer, int mode) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedFramebufferDrawBuffer(framebuffer, mode);
    }

    public static void glNamedFramebufferDrawBuffers(int framebuffer, java.nio.IntBuffer bufs) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedFramebufferDrawBuffers(framebuffer, bufs);
    }

    public static void glNamedFramebufferParameteri(int framebuffer, int pname, int param) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedFramebufferParameteri(framebuffer, pname, param);
    }

    public static void glNamedFramebufferReadBuffer(int framebuffer, int mode) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedFramebufferReadBuffer(framebuffer, mode);
    }
    ...
    public static void glNamedFramebufferTexture(int framebuffer, int attachment, int texture, int level) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedFramebufferTexture(framebuffer, attachment, texture, level);
    }
    ...
    public static void glNamedRenderbufferStorage(int renderbuffer, int internalformat, int width, int height) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glNamedRenderbufferStorage(renderbuffer, internalformat, width, height);
    }
    ...
    public static void glTextureBuffer(int texture, int internalformat, int buffer) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureBuffer(texture, internalformat, buffer);
    }

    public static void glTextureBufferRange(int texture, int internalformat, int buffer, long offset, long size) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureBufferRange(texture, internalformat, buffer, offset, size);
    }

    public static void glTextureParameterf(int texture, int pname, float param) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureParameterf(texture, pname, param);
    }

    public static void glTextureParameteri(int texture, int pname, int param) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureParameteri(texture, pname, param);
    }

    public static void glTextureStorage1D(int texture, int levels, int internalformat, int width) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureStorage1D(texture, levels, internalformat, width);
    }

    public static void glTextureStorage2D(int texture, int levels, int internalformat, int width, int height) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureStorage2D(texture, levels, internalformat, width, height);
    }
    ...
    public static void glTextureStorage3D(int texture, int levels, int internalformat, int width, int height,
            int depth) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureStorage3D(texture, levels, internalformat, width, height, depth);
    }
    ...
    public static void glTextureStorage3DMultisample(int texture, int samples, int internalformat, int width,
        ...
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureStorage3DMultisample(
                texture,
                samples,
                internalformat,
                width,
    ...
    public static void glTextureSubImage1D(int texture, int level, int xoffset, int width, int format, int type,
        ...
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureSubImage1D(texture, level, xoffset, width, format, type, pixels);
    }
    ...
    public static void glTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height,
        ...
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureSubImage2D(
                texture,
                level,
                xoffset,
                yoffset,
    ...
    public static void glTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int width,
        ...
        org.lwjgl3.opengl.ARBDirectStateAccess.glTextureSubImage3D(
                texture,
                level,
                xoffset,
                yoffset,
    ...
    public static void glTransformFeedbackBufferBase(int xfb, int index, int buffer) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTransformFeedbackBufferBase(xfb, index, buffer);
    }

    public static void glTransformFeedbackBufferRange(int xfb, int index, int buffer, long offset, long size) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glTransformFeedbackBufferRange(xfb, index, buffer, offset, size);
    }

    public static boolean glUnmapNamedBuffer(int buffer) {
        return org.lwjgl3.opengl.ARBDirectStateAccess.glUnmapNamedBuffer(buffer);
    }

    public static void glVertexArrayAttribBinding(int vaobj, int attribindex, int bindingindex) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glVertexArrayAttribBinding(vaobj, attribindex, bindingindex);
    }
    ...
    public static void glVertexArrayBindingDivisor(int vaobj, int bindingindex, int divisor) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glVertexArrayBindingDivisor(vaobj, bindingindex, divisor);
    }

    public static void glVertexArrayElementBuffer(int vaobj, int buffer) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glVertexArrayElementBuffer(vaobj, buffer);
    }

    public static void glVertexArrayVertexBuffer(int vaobj, int bindingindex, int buffer, long offset, int stride) {
        org.lwjgl3.opengl.ARBDirectStateAccess.glVertexArrayVertexBuffer(vaobj, bindingindex, buffer, offset, stride);
    }
}
