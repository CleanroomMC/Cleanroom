...
public class ARBVertexAttribBinding {
    ...
    public static void glBindVertexBuffer(int bindingindex, int buffer, long offset, int stride) {
        org.lwjgl3.opengl.ARBVertexAttribBinding.glBindVertexBuffer(bindingindex, buffer, offset, stride);
    }

    public static void glVertexAttribBinding(int attribindex, int bindingindex) {
        org.lwjgl3.opengl.ARBVertexAttribBinding.glVertexAttribBinding(attribindex, bindingindex);
    }

    public static void glVertexAttribFormat(int attribindex, int size, int type, boolean normalized,
            int relativeoffset) {
        org.lwjgl3.opengl.ARBVertexAttribBinding
                .glVertexAttribFormat(attribindex, size, type, normalized, relativeoffset);
    }

    public static void glVertexAttribIFormat(int attribindex, int size, int type, int relativeoffset) {
        org.lwjgl3.opengl.ARBVertexAttribBinding.glVertexAttribIFormat(attribindex, size, type, relativeoffset);
    }

    public static void glVertexAttribLFormat(int attribindex, int size, int type, int relativeoffset) {
        org.lwjgl3.opengl.ARBVertexAttribBinding.glVertexAttribLFormat(attribindex, size, type, relativeoffset);
    }

    public static void glVertexBindingDivisor(int bindingindex, int divisor) {
        org.lwjgl3.opengl.ARBVertexAttribBinding.glVertexBindingDivisor(bindingindex, divisor);
    }
}
