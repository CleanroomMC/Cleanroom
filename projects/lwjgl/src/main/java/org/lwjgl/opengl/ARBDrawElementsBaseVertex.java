...
public class ARBDrawElementsBaseVertex {
    ...
    public static void glDrawElementsBaseVertex(int mode, int indices_count, int type, long indices_buffer_offset,
            int basevertex) {
        org.lwjgl3.opengl.ARBDrawElementsBaseVertex
                .glDrawElementsBaseVertex(mode, indices_count, type, indices_buffer_offset, basevertex);
    }

    public static void glDrawElementsBaseVertex(int mode, java.nio.ByteBuffer indices, int basevertex) {
        org.lwjgl3.opengl.ARBDrawElementsBaseVertex.glDrawElementsBaseVertex(mode, indices, basevertex);
    }
    ...
    public static void glDrawElementsInstancedBaseVertex(int mode, int indices_count, int type,
        ...
        org.lwjgl3.opengl.ARBDrawElementsBaseVertex.glDrawElementsInstancedBaseVertex(
                mode,
                indices_count,
                type,
    ...
    public static void glDrawElementsInstancedBaseVertex(int mode, java.nio.ByteBuffer indices, int primcount,
            int basevertex) {
        org.lwjgl3.opengl.ARBDrawElementsBaseVertex
                .glDrawElementsInstancedBaseVertex(mode, indices, primcount, basevertex);
    }
    ...
    public static void glDrawRangeElementsBaseVertex(int mode, int start, int end, int indices_count, int type,
        ...
        org.lwjgl3.opengl.ARBDrawElementsBaseVertex.glDrawRangeElementsBaseVertex(
                mode,
                start,
                end,
                indices_count,
    ...
    public static void glDrawRangeElementsBaseVertex(int mode, int start, int end, java.nio.ByteBuffer indices,
            int basevertex) {
        org.lwjgl3.opengl.ARBDrawElementsBaseVertex.glDrawRangeElementsBaseVertex(mode, start, end, indices, basevertex);
    }
