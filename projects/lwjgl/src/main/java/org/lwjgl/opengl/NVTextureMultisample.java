...
public class NVTextureMultisample {
    ...
    public static void glTexImage2DMultisampleCoverageNV(int target, int coverageSamples, int colorSamples,
        ...
        org.lwjgl3.opengl.NVTextureMultisample.glTexImage2DMultisampleCoverageNV(
                target,
                coverageSamples,
                colorSamples,
                internalFormat,
    ...
    public static void glTexImage3DMultisampleCoverageNV(int target, int coverageSamples, int colorSamples,
        ...
        org.lwjgl3.opengl.NVTextureMultisample.glTexImage3DMultisampleCoverageNV(
                target,
                coverageSamples,
                colorSamples,
                internalFormat,
    ...
    public static void glTextureImage2DMultisampleCoverageNV(int texture, int target, int coverageSamples,
        ...
        org.lwjgl3.opengl.NVTextureMultisample.glTextureImage2DMultisampleCoverageNV(
                texture,
                target,
                coverageSamples,
                colorSamples,
    ...
    public static void glTextureImage2DMultisampleNV(int texture, int target, int samples, int internalFormat,
        ...
        org.lwjgl3.opengl.NVTextureMultisample.glTextureImage2DMultisampleNV(
                texture,
                target,
                samples,
                internalFormat,
    ...
    public static void glTextureImage3DMultisampleCoverageNV(int texture, int target, int coverageSamples,
        ...
        org.lwjgl3.opengl.NVTextureMultisample.glTextureImage3DMultisampleCoverageNV(
                texture,
                target,
                coverageSamples,
                colorSamples,
    ...
    public static void glTextureImage3DMultisampleNV(int texture, int target, int samples, int internalFormat,
        ...
        org.lwjgl3.opengl.NVTextureMultisample.glTextureImage3DMultisampleNV(
                texture,
                target,
                samples,
                internalFormat,
