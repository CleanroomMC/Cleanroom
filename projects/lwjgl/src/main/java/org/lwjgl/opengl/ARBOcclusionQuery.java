...
public class ARBOcclusionQuery {
    ...
    public static void glBeginQueryARB(int target, int id) {
        org.lwjgl3.opengl.ARBOcclusionQuery.glBeginQueryARB(target, id);
    }

    public static void glDeleteQueriesARB(int id) {
        org.lwjgl3.opengl.ARBOcclusionQuery.glDeleteQueriesARB(id);
    }

    public static void glDeleteQueriesARB(java.nio.IntBuffer ids) {
        org.lwjgl3.opengl.ARBOcclusionQuery.glDeleteQueriesARB(ids);
    }

    public static void glEndQueryARB(int target) {
        org.lwjgl3.opengl.ARBOcclusionQuery.glEndQueryARB(target);
    }

    public static int glGenQueriesARB() {
        return org.lwjgl3.opengl.ARBOcclusionQuery.glGenQueriesARB();
    }

    public static void glGenQueriesARB(java.nio.IntBuffer ids) {
        org.lwjgl3.opengl.ARBOcclusionQuery.glGenQueriesARB(ids);
    }

    public static void glGetQueryARB(int target, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.ARBOcclusionQuery.glGetQueryivARB(target, pname, params);
    }

    public static void glGetQueryObjectARB(int id, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.ARBOcclusionQuery.glGetQueryObjectivARB(id, pname, params);
    }

    public static int glGetQueryObjectiARB(int id, int pname) {
        return org.lwjgl3.opengl.ARBOcclusionQuery.glGetQueryObjectiARB(id, pname);
    }

    public static void glGetQueryObjectuARB(int id, int pname, java.nio.IntBuffer params) {
        org.lwjgl3.opengl.ARBOcclusionQuery.glGetQueryObjectuivARB(id, pname, params);
    }

    public static int glGetQueryObjectuiARB(int id, int pname) {
        return org.lwjgl3.opengl.ARBOcclusionQuery.glGetQueryObjectuiARB(id, pname);
    }

    public static int glGetQueryiARB(int target, int pname) {
        return org.lwjgl3.opengl.ARBOcclusionQuery.glGetQueryiARB(target, pname);
    }

    public static boolean glIsQueryARB(int id) {
        return org.lwjgl3.opengl.ARBOcclusionQuery.glIsQueryARB(id);
    }
}
