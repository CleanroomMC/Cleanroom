...
public class GL31 {
    ...
    public static void glCopyBufferSubData(int readtarget, int writetarget, long readoffset, long writeoffset,
            long size) {
        org.lwjgl3.opengl.GL31.glCopyBufferSubData(readtarget, writetarget, readoffset, writeoffset, size);
    }

    public static void glDrawArraysInstanced(int mode, int first, int count, int primcount) {
        org.lwjgl3.opengl.GL31.glDrawArraysInstanced(mode, first, count, primcount);
    }

    public static void glDrawElementsInstanced(int mode, int indices_count, int type, long indices_buffer_offset,
            int primcount) {
        org.lwjgl3.opengl.GL31.glDrawElementsInstanced(mode, indices_count, type, indices_buffer_offset, primcount);
    }

    public static void glDrawElementsInstanced(int mode, java.nio.ByteBuffer indices, int primcount) {
        org.lwjgl3.opengl.GL31.glDrawElementsInstanced(mode, indices, primcount);
    }
    ...
    public static void glGetActiveUniformBlock(int program, int uniformBlockIndex, int pname,
        ...
        org.lwjgl3.opengl.GL31.glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params);
    }
    ...
    public static void glGetActiveUniformBlockName(int program, int uniformBlockIndex, java.nio.IntBuffer length,
        ...
        org.lwjgl3.opengl.GL31.glGetActiveUniformBlockName(program, uniformBlockIndex, length, uniformBlockName);
    }

    public static int glGetActiveUniformBlocki(int program, int uniformBlockIndex, int pname) {
        return org.lwjgl3.opengl.GL31.glGetActiveUniformBlocki(program, uniformBlockIndex, pname);
    }

    public static java.lang.String glGetActiveUniformName(int program, int uniformIndex, int bufSize) {
        return org.lwjgl3.opengl.GL31.glGetActiveUniformName(program, uniformIndex, bufSize);
    }
    ...
    public static void glGetActiveUniformName(int program, int uniformIndex, java.nio.IntBuffer length,
        ...
        org.lwjgl3.opengl.GL31.glGetActiveUniformName(program, uniformIndex, length, uniformName);
    }

    public static void glGetActiveUniforms(int program, java.nio.IntBuffer uniformIndices, int pname,
            java.nio.IntBuffer params) {
        org.lwjgl3.opengl.GL31.glGetActiveUniformsiv(program, uniformIndices, pname, params);
    }

    public static int glGetActiveUniformsi(int program, int uniformIndex, int pname) {
        return org.lwjgl3.opengl.GL31.glGetActiveUniformsi(program, uniformIndex, pname);
    }

    public static int glGetUniformBlockIndex(int program, java.lang.CharSequence uniformBlockName) {
        return org.lwjgl3.opengl.GL31.glGetUniformBlockIndex(program, uniformBlockName);
    }
    ...
    public static void glGetUniformIndices(int program, java.lang.CharSequence[] uniformNames,
        ...
        org.lwjgl3.opengl.GL31.glGetUniformIndices(program, uniformNames, uniformIndices);
    }

    public static void glPrimitiveRestartIndex(int index) {
        org.lwjgl3.opengl.GL31.glPrimitiveRestartIndex(index);
    }

    public static void glTexBuffer(int target, int internalformat, int buffer) {
        org.lwjgl3.opengl.GL31.glTexBuffer(target, internalformat, buffer);
    }

    public static void glUniformBlockBinding(int program, int uniformBlockIndex, int uniformBlockBinding) {
        org.lwjgl3.opengl.GL31.glUniformBlockBinding(program, uniformBlockIndex, uniformBlockBinding);
    }
}
