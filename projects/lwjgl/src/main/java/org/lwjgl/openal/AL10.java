...
public class AL10 {
    ...
    public static void alDeleteBuffers(java.nio.IntBuffer buffers) {
        org.lwjgl3.openal.AL10.alDeleteBuffers(buffers);
    }

    public static void alDeleteSources(int source) {
        org.lwjgl3.openal.AL10.alDeleteSources(source);
    }

    public static void alDeleteSources(java.nio.IntBuffer sources) {
        org.lwjgl3.openal.AL10.alDeleteSources(sources);
    }

    public static void alDisable(int capability) {
        org.lwjgl3.openal.AL10.alDisable(capability);
    }

    public static void alDistanceModel(int value) {
        org.lwjgl3.openal.AL10.alDistanceModel(value);
    }

    public static void alDopplerFactor(float value) {
        org.lwjgl3.openal.AL10.alDopplerFactor(value);
    }

    public static void alDopplerVelocity(float value) {
        org.lwjgl3.openal.AL10.alDopplerVelocity(value);
    }

    public static void alEnable(int capability) {
        org.lwjgl3.openal.AL10.alEnable(capability);
    }

    public static int alGenBuffers() {
        return org.lwjgl3.openal.AL10.alGenBuffers();
    }

    public static void alGenBuffers(java.nio.IntBuffer buffers) {
        org.lwjgl3.openal.AL10.alGenBuffers(buffers);
    }

    public static int alGenSources() {
        return org.lwjgl3.openal.AL10.alGenSources();
    }

    public static void alGenSources(java.nio.IntBuffer sources) {
        org.lwjgl3.openal.AL10.alGenSources(sources);
    }

    public static boolean alGetBoolean(int pname) {
        return org.lwjgl3.openal.AL10.alGetBoolean(pname);
    }

    public static float alGetBufferf(int buffer, int pname) {
        return org.lwjgl3.openal.AL10.alGetBufferf(buffer, pname);
    }

    public static int alGetBufferi(int buffer, int pname) {
        return org.lwjgl3.openal.AL10.alGetBufferi(buffer, pname);
    }

    public static double alGetDouble(int pname) {
        return org.lwjgl3.openal.AL10.alGetDouble(pname);
    }

    public static void alGetDouble(int pname, java.nio.DoubleBuffer data) {
        org.lwjgl3.openal.AL10.alGetDoublev(pname, data);
    }

    public static int alGetEnumValue(java.lang.String ename) {

        int returnValue = org.lwjgl3.openal.AL10.alGetEnumValue(ename);
