...
public class SoundEngineFixTransformer implements IClassTransformer
{
    ...
    public byte[] transform(String name, String transformedName, byte[] basicClass)
    {
        switch (transformedName) {
            ...
            case "paulscode.sound.Library" -> {
                ...
                MethodNode method = getMethodNode(classNode, "removeSource", "(Ljava/lang/String;)V", transformedName, " - no removeSource method found");
            ...
            case "paulscode.sound.StreamThread" -> {
                ...
                MethodNode method = getMethodNode(classNode, "run", "()V", transformedName, " - no run method found");
    ...
    private static MethodNode getMethodNode(ClassNode classNode, String removeSource, String anObject, String transformedName, String x) {
        ...
        for (MethodNode m : classNode.methods) {
            if (m.name.equals(removeSource) && m.desc.equals(anObject)) // trying to find paulscode.sound.Library.removeSource(String)
            {
                method = m;
                break;
            }
